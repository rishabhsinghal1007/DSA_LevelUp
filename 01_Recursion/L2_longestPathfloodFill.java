public class L2_longestPathfloodFill {
    ...
    public static pathPair floodFill_LongestPath(int sr, int sc, int er, int ec, int[][] dir, String[] Sdir, boolean[][] vis) {
        ...
        for (int d = 0; d < dir.length; d++) {
            ...
            if (r >= 0 && c >= 0 && r <= er && c <= ec && !vis[r][c]) {
                ...
                if (recAns.len + 1 > myAns.len) { // like compairing to find the longest path
    ...
    public static void main(String[] args) {
        ...
        pathPair ans = floodFill_LongestPath(0, 0, n - 1, m - 1, dir, Sdir, vis);
